...
namespace About
{
    public partial class MainForm : System.Windows.Forms.Form
    {
        ...
        private void lblCurrentChangelog_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            try
            {
                string site = "https://github.com/chris-mackay/CRMRevitTools-v2019/releases/tag/" + version;
                Process.Start(site);
            }
            catch (Exception ex)
            {
        ...
        private void lblChangelog_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            try
            {
                string site = "https://github.com/chris-mackay/CRMRevitTools-v2019/releases";
                Process.Start(site);
            }
            catch (Exception ex)
            {
        ...
        private void lblSource_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            try
            {
                string site = "https://github.com/chris-mackay/CRMRevitTools-v2019";
                Process.Start(site);
            }
            catch (Exception ex)
            {
